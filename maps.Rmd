---
title: "COVID-19 rates in L.A. County"
...
A handful of neighborhoods include the counts associated with correctional facility outbreaks.

```{r echo=FALSE}
csa.cleaned %>% 
  select(csa.hood.name, mapla.region.slug, date, cases, population, rate.cases, includes.prisons) %>% 
  datatable()
```
